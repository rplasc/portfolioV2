...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col bg-linear-to-t from-slate-500 from-40% to-slate-900">
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-20 px-6 py-20">
        ...
        <section className="flex flex-col gap-4 md:flex-row md:items-center md:gap-8">
          <h2 className="shrink-0 font-mono text-xs font-semibold tracking-[0.2em] text-white/40 uppercase">
            Previously at
          </h2>
